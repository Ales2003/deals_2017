...
public class MyServicesTest {
	...
	public static void main(String[] args) {
		...
		/*
		 * контекст приложения ClassPathXmlApplicationContext
		 * загружает определения компонентов из XML-файла,
		 * расположенного в библиотеке классов (classpath), и обрабатывает файлы
		 * с определениями контекстов как ресурсы
		 */
		...
		// !!! когда имплементаций несколько, контекст не отдаст бин по интерфейсу,
